...
### KEYS Function
```{r KEYS}
# Ultimately decided abstract the API keys.
KEYS <- function() {
...
KEYS()$google.speech
```
### en.translator Function
```{r en.translator}
# Takes character vectors and returns English translation as df.
...
### create.news.url Function
```{r create.news.url}
# Serves as the foundation for df.article().
...
### df.article Function
```{r df.article}
# Returns df of top 100 article on specified date. (Note: A function that returns a 
...
### get.title Function
```{r get.title}
# Returns translated titles that contain specified keyword.
