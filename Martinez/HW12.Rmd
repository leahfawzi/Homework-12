...
## SOURCING MY CODE AND SHOWING OUTPUT FOR FUNCTIONS

```{r, cache=TRUE}
source("globo_ api.R")

search_newspaper_url(globo_api_key, "Bolsonaro")
#I created an object, so I wouldn't have to continue writing my search word and newspaper api again and again in the functions 
url <-  search_newspaper_url(globo_api_key, "Bolsonaro")

access_newspaper(url)$articles[1,]

translate_text(url, google_api_key, 3)

text_to_speech(url, google_api_key, 3)
